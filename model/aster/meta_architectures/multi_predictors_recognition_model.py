...
from model.aster.core import model
from model.aster.core import standard_fields as fields
from model.aster.c_ops import ops
from model.aster.utils import shape_utils
...
class MultiPredictorsRecognitionModel(model.Model):
  ...
  def postprocess(self, predictions_dict: object, scope: object = None) -> object:
  ...
  def _aggregate_recognition_results(self, text_list, scores_list, scope=None):
    """Aggregate aster results by picking up ones with highest scores.
    Args
