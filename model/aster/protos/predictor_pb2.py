...
import model.aster.protos.rnn_cell_pb2
import model.aster.protos.hyperparams_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[model.aster.protos.rnn_cell_pb2.DESCRIPTOR, model.aster.protos.hyperparams_pb2.DESCRIPTOR, model.aster.protos.label_map_pb2.DESCRIPTOR, model.aster.protos.loss_pb2.DESCRIPTOR, ])
...
_ATTENTIONPREDICTOR.fields_by_name['rnn_cell'].message_type = model.aster.protos.rnn_cell_pb2._RNNCELL
_ATTENTIONPREDICTOR.fields_by_name['rnn_regularizer'].message_type = model.aster.protos.hyperparams_pb2._REGULARIZER
_ATTENTIONPREDICTOR.fields_by_name['label_map'].message_type = model.aster.protos.label_map_pb2._LABELMAP
_ATTENTIONPREDICTOR.fields_by_name['loss'].message_type = model.aster.protos.loss_pb2._LOSS
_ATTENTIONPREDICTOR.fields_by_name['lm_rnn_cell'].message_type = _LANGUAGEMODELRNNCELL
_LANGUAGEMODELRNNCELL.fields_by_name['rnn_cell'].message_type = model.aster.protos.rnn_cell_pb2._RNNCELL
